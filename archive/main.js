...
function preload () {
    ...
    game.load.image('Town_A', 'assets/tilesets/graveyard.png');
    ...
    game.load.spritesheet('button', 'assets/buttons/button_sprite_sheet.png', 
        193, 71)
...
function handler() {
    ...
    if(game) {
        ...
        selectorY = Math.ceil(pcg_tilemap.tilesets[0].tilecount/
            pcg_tilemap.height);    // number of rows of tiles
