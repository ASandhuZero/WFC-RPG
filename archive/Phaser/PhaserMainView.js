...
export class MainState extends Phaser.State {
    ...
    preload () {
        ...
        this.game.load.tilemap(this.mapName, null, this.tileMap, 
            Phaser.Tilemap.TILED_JSON);
        this.game.load.image('Town_A', 'assets/tilesets/graveyard.png');
    ...
    create () {
        ...
        if(this.includeItem == true){
            this.map.createFromObjects('items', this.tileNum*this.tileNum+1, 
                'key', 0, true, false, items);
            this.map.createFromObjects('items', this.tileNum*this.tileNum+2, 
                'chest', 0, true, false, items);
        }
