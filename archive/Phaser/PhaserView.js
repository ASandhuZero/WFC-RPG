...
export class PhaserView {
    ...
    createNewGame() {
        ...
        this.game = new Game(this.worldLength, this.worldWidth, this.selectorY, 
            this.tileSize, this.tileNum, this.tileMap, this.editor, 
            this.includeItem);
    }
}
...
class Game extends Phaser.Game {
	...
	constructor(worldLength, worldWidth, selectorY, tileSize, tileNum, 
        tileMap, editor, includeItem) {
            super(worldWidth, worldLength, Phaser.AUTO, 'content', null);
            this.state.add('MainState', MainState, false);
            this.state.start('MainState', false, false, selectorY, 
                tileSize, tileNum, tileMap, includeItem);
            // this.state.start('MainState', false, false, selectorY, tileSize,
            //    tileNum, tileMap, editor, includeItem);
	}
