...
var shimmedKeys = require('../index');
var is = require('is');
var keys = require('../shim');
...
test('shadowed properties', function(t) {
  var shadowedProps = ['dummyControlProp', 'constructor', 'hasOwnProperty', 'isPrototypeOf', 'propertyIsEnumerable', 'toLocaleString', 'toString', 'valueOf'];
  shadowedProps.sort();
  var shadowedObject = {};
