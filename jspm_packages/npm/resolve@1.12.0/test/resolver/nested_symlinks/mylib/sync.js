...
(function(process) {
  ...
  var b = require('../../../../index').sync('buffer/', {preserveSymlinks: true}).replace(process.cwd(), '$CWD');
  var c = require('../../../../index').sync('buffer/', {preserveSymlinks: false}).replace(process.cwd(), '$CWD');
