    ...
    return function o(i, n, l) {
        ...
        r.exports = function t(r, i, a) {
          ...
          function c(o) {
            ...
            function r(e) {
              ...
              if (s(r))
                throw new Error("Schema " + r + " is loaded but " + e.missingRef + " cannot be resolved");
        ...
        r.exports = function c(e, u, h, r) {
          ...
          function b(e, r, t) {
            ...
            var a,
                ...
                o = m[r];
            if (void 0 !== o)
              return _(a = d[o], s = "refVal[" + o + "]");
            if (!t && u.refs) {
              var i = u.refs[r];
              if (void 0 !== i)
                return s = S(r, a = u.refVal[i]), _(a, s);
            }
            s = S(r);
            var n = $.call(f, w, u, r);
            if (void 0 === n) {
          ...
          function R(e, r, t, a) {
            ...
            if (c)
              ...
              l = u.call(f, a, e.keyword, r, t);
            else if (!(l = e.definition.validate))
              return;
            if (void 0 === l)
      ...
      6: [function(e, r, t) {
        ...
        function n(e, r, t, a) {
          if (e.fragment = e.fragment || "", "/" == e.fragment.slice(0, 1)) {
            for (var s = e.fragment.split("/"),
                o = 1; o < s.length; o++) {
              var i = s[o];
              if (i) {
                if (void 0 === (t = t[i = y.unescapeFragment(i)]))
                  break;
                var n;
        ...
        r.exports = function(e, r) {
          for (var t = 0; t < r.length; t++) {
            ...
            for (a = 0; a < l.length; a++) {
              var i = l[a],
                  n = o[i];
              n && (o[i] = {anyOf: [n, {$ref: "https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/data.json#"}]});
            }
          }
          return e;
        };
      ...
      22: [function(e, r, t) {
        ...
        r.exports = function(e, r, t) {
          ...
          if (y || g || (o += x + " = null;"), o += "var " + p + " = errors;var " + f + ";", m && S.$data && (_ += "}", o += " if (" + s + " === undefined) { " + f + " = true; } else { ", F && (_ += "}", o += " " + f + " = " + b + ".validateSchema(" + s + "); if (" + f + ") { ")), y)
      ...
      25: [function(e, r, t) {
        ...
        r.exports = function(e, r, t) {
          ...
          if (d) {
            ...
            if (!(m = e.formats[i])) {
              if ("ignore" == f)
                return e.logger.warn('unknown format "' + i + '" ignored in schema at path "' + e.errSchemaPath + '"'), c && (a += " if (true) { "), a;
              if (p && 0 <= f.indexOf(i))
                return c && (a += " if (true) { "), a;
                ...
                if (e.opts.strictKeywords ? "object" == typeof Y && 0 < Object.keys(Y).length : e.util.schemaHasRules(Y, e.RULES.all)) {
                  ...
                  if (X)
                    ...
                    if (I && I[J]) {
                      ...
                      c ? (a += " if ( " + ee + " === undefined ", D && (a += " || ! Object.prototype.hasOwnProperty.call(" + u + ", '" + e.util.escapeQuotes(J) + "') "), a += ") { " + p + " = true; } else { ") : (a += " if (" + ee + " !== undefined ", D && (a += " &&   Object.prototype.hasOwnProperty.call(" + u + ", '" + e.util.escapeQuotes(J) + "') "), a += " ) { ");
                    a += " " + K + " } ";
                  }
                }
                c && (a += " if (" + p + ") { ", f += "}");
        ...
        r.exports = function(e, r, t) {
          ...
          if (s) {
            ...
            if (o = y.pop(), a) {
              ...
              o += " if (!" + g + ") { if (vErrors === null) vErrors = " + s + ".errors; else vErrors = vErrors.concat(" + s + ".errors); errors = vErrors.length; } ", c && (o += " else { ");
          }
          return o;
        };
      }, {}],
        ...
        r.exports = function(e, r, t) {
          ...
          if (a = f ? (s += " var schema" + o + " = " + e.util.getData(n.$data, i, e.dataPathArr) + "; ", "schema" + o) : n, (n || f) && !1 !== e.opts.uniqueItems) {
            ...
            if (!p || "object" == p || "array" == p || m && (0 <= p.indexOf("object") || 0 <= p.indexOf("array")))
              s += " outer: for (;i--;) { for (j = i; j--;) { if (equal(" + h + "[i], " + h + "[j])) { " + d + " = false; break outer; } } } ";
            else
        ...
        r.exports = function(a, e, r) {
          ...
          if (a.isTop && (t += " var validate = ", s && (a.async = !0, t += "async "), t += "function(data, dataPath, parentData, parentDataProperty, rootData) { 'use strict'; ", i && (a.opts.sourceCode || a.opts.processCode) && (t += " /*# sourceURL=" + i + " */ ")), "boolean" == typeof a.schema || !o && !a.schema.$ref) {
            ...
            if (!1 === a.schema) {
              ...
              t += a.isTop ? s ? " return data; " : " validate.errors = null; return true; " : " var " + v + " = true; ";
          ...
          if (b && a.opts.nullable && !0 === a.schema.nullable && (S ? -1 == b.indexOf("null") && (b = b.concat("null")) : "null" != b && (b = [b, "null"], S = !0)), S && 1 == b.length && (b = b[0], S = !1), a.schema.$ref && o) {
            if ("fail" == a.opts.extendRefs)
              throw new Error('$ref: validation keywords used in schema at path "' + a.errSchemaPath + '" (see option extendRefs)');
          ...
          if (a.schema.$ref && !o)
            t += " " + a.RULES.all.$ref.code(a, "$ref") + " ", p && (t += " } if (errors === ", t += g ? "0" : "errs_" + c, t += ") { ", w += "}");
          else {
            var C = a.RULES;
            if (C)
              for (var k = -1,
                        ...
                        for (var T,
                          ...
                          if (void 0 !== (V = h[T = z[q += 1]]).default) {
                            ...
                            if (a.compositeRule) {
                              ...
                              t += " if (" + Q + " === undefined ", "empty" == a.opts.useDefaults && (t += " || " + Q + " === null || " + Q + " === '' "), t += " ) " + Q + " = ", t += "shared" == a.opts.useDefaults ? " " + a.useDefault(V.default) + " " : " " + JSON.stringify(V.default) + " ", t += "; ";
                          }
                        }
          ...
          add: function(e, r) {
            ...
            if (r) {
              ...
              if (Array.isArray(t))
                ...
                o(e, t, r);
              var s = r.metaSchema;
              s && (r.$data && this._opts.$data && (s = {anyOf: [s, {$ref: "https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/data.json#"}]}), r.validateSchema = this.compile(s, !0));
            }
            function o(e, r, t) {
              for (var a,
                  s = 0; s < n.length; s++) {
            ...
            if (s && "object" == typeof s && !Array.isArray(s)) {
              for (var h in t(s, o, i, n, l, c, u), s) {
                ...
                if (Array.isArray(d)) {
                  ...
                  (h in m.keywords || r.allKeys && !(h in m.skipKeywords)) && e(r, t, a, d, o + "/" + h, i, o, h, s);
              }
              a(s, o, i, n, l, c, u);
            }
        ...
        a = this, function(e) {
              ...
              w = function(e, r) {
                ...
                if (Symbol.iterator in Object(e))
                  return function(e, r) {
                    ...
                    try {
                      for (var i,
                          n = e[Symbol.iterator](); !(a = (i = n.next()).done) && (t.push(i.value), !r || t.length !== r); a = !0)
                        ;
                    } catch (e) {
                      s = !0, o = e;
                    } finally {
          ...
          var N = function(e, r) {
            return e + 22 + 75 * (e < 26) - ((0 != r) << 5);
              ...
              c = function(e) {
                ...
                try {
                  for (var c,
                      u = e[Symbol.iterator](); !(i = (c = u.next()).done); i = !0) {
                    var h = c.value;
                    h < 128 && r.push(z(h));
                  }
                } catch (e) {
                ...
                for (d && r.push("-"); f < t; ) {
                  ...
                  try {
                    for (var g,
                        P = e[Symbol.iterator](); !(m = (g = P.next()).done); m = !0) {
                      var E = g.value;
                      a <= E && E < p && (p = E);
                    }
                  } catch (e) {
                  ...
                  try {
                    for (var F,
                        x = e[Symbol.iterator](); !(b = (F = x.next()).done); b = !0) {
                      var R = F.value;
          ...
          function g(e, r) {
            var t = e.match(r.IPV6ADDRESS) || [],
                ...
                o = a[2];
            if (s) {
              for (var i = s.toLowerCase().split("::").reverse(),
                  n = w(i, 2),
                  l = n[0],
                  c = n[1],
                  u = c ? c.split(":").map(b) : [],
      ...
      ajv: [function(a, e, r) {
        ...
        (e.exports = y).prototype.validate = function(e, r) {
          ...
          if (!(t = t || this._opts.defaultMeta || (a = this, s = a._opts.meta, a._opts.defaultMeta = "object" == typeof s ? a._getId(s) || s : a.getSchema(p) ? p : void 0, a._opts.defaultMeta)))
          ...
          if (!(e = e || this.errors))
            return "No errors";
          for (var t = void 0 === (r = r || {}).separator ? ", " : r.separator,
          ...
          if (t.compiling)
            return (t.validate = s).schema = t.schema, s.errors = null, s.root = e || s, !0 === t.schema.$async && (s.$async = !0), s;
          var r,
              a;
