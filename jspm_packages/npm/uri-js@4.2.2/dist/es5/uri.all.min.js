  ...
  !function(e, r) {
    ...
    function m(e, r) {
      var n = e.match(r.IPV6ADDRESS) || [],
          ...
          a = t[2];
      if (o) {
        for (var i = o.toLowerCase().split("::").reverse(),
            u = R(i, 2),
            s = u[0],
            f = u[1],
            c = f ? f.split(":").map(g) : [],
    ...
    var F = u(!1),
        ...
        R = function() {
          function e(e, r) {
            ...
            try {
              for (var i,
                  u = e[Symbol.iterator](); !(t = (i = u.next()).done) && (n.push(i.value), !r || n.length !== r); t = !0)
                ;
            } catch (s) {
              o = !0, a = s;
            } finally {
        ...
        Z = function(e) {
          ...
          try {
            for (var c,
                h = e[Symbol.iterator](); !(i = (c = h.next()).done); i = !0) {
              var d = c.value;
              d < 128 && r.push(z(d));
            }
          } catch (j) {
          ...
          for (l && r.push("-"); g < n; ) {
            ...
            try {
              for (var y,
                  S = e[Symbol.iterator](); !(m = (y = S.next()).done); m = !0) {
                var A = y.value;
                A >= t && A < v && (v = A);
              }
            } catch (j) {
            ...
            try {
              for (var O,
                  I = e[Symbol.iterator](); !(w = (O = I.next()).done); w = !0) {
                var F = O.value;
        ...
        le = {
          ...
          parse: function(e, r) {
            ...
            for (var d = 0,
                l = t.length; d < l; ++d) {
              var g = t[d].split("@");
              if (g[0] = O(g[0]), r.unicodeSupport)
                g[1] = O(g[1], r).toLowerCase();
              else
                try {
