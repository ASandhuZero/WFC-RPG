System.config({
  ...
  map: {
    ...
    "npm:electron@3.0.4": {
      "@types/node": "npm:@types/node@8.10.36",
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
    ...
    "npm:form-data@2.3.3": {
      ...
      "http": "github:jspm/nodelibs-http@1.7.1",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "mime-types": "npm:mime-types@2.1.20",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0"
    ...
    "npm:mime-types@2.1.20": {
      "mime-db": "npm:mime-db@1.36.0",
      "path": "github:jspm/nodelibs-path@0.1.0"
    },
    "npm:mkdirp@0.5.1": {
      "fs": "github:jspm/nodelibs-fs@0.1.2",
    ...
    "npm:request@2.88.0": {
      ...
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "har-validator": "npm:har-validator@5.1.0",
      "http": "github:jspm/nodelibs-http@1.7.1",
    ...
    "npm:spdx-correct@3.0.2": {
      ...
      "spdx-license-ids": "npm:spdx-license-ids@3.0.1"
    },
